...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      outline:
        "border-2 border-primary font-bold text-primary bg-background hover:bg-accent hover:text-accent-foreground",
      secondary:
        "bg-transparent font-bold border-solid border-2 border-primary text-primary hover:bg-secondary/80",
