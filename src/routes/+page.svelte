...
<Alert.Root>
  ...
  <Alert.Description>
    Test you create won't be saved on exit!
  </Alert.Description>
</Alert.Root>


<div class="py-20 flex justify-center">
  <Button variant="outline" class="py-8 my-4" on:click={() => createTestDialogOpen = true}>
...
<Dialog.Root bind:open={createTestDialogOpen}>
  <Dialog.Content>
    <Dialog.Header>
      ...
      <Dialog.Description>
        Create either a new test with blocks or via script.
      </Dialog.Description>
    </Dialog.Header>
