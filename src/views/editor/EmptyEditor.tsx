  ...
  return (
    <div className="flex flex-auto flex-col items-center">
      ...
      <h2 className="mb-8 font-thin">
        Start your journey by choosing a type of test
      </h2>
      <div className="flex items-center justify-center gap-12">
        <div className="flex w-64 flex-col items-center">
          ...
          <p className="mb-4 text-center font-thin">
            Use our interactive UI to compose GET, POST, DELETE and more
            requests.
          </p>
        ...
        <div className="flex w-64 flex-col items-center">
          ...
          <p className="mb-4 text-center font-thin">
            Use our code samples as a foundation for your script or start from a
            clean slate.
          </p>
